...
typedef struct {
     ...
     * may be opaque on some device types. This pointer is always aligned to 256 bytes as in CUDA.
     * The `byte_offset` field should be used to point to the beginning of the data.
     *
